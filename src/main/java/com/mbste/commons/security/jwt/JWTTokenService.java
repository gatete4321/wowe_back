...
import com.mbste.commons.security.dates.DateService;
...
public class JWTTokenService implements TokenService,Clock {
    ...
    private static final GzipCompressionCodec COMPRESSION_CODEC = new
    ...
    JWTTokenService(final DateService dates,
                    ...
                    @Value("${jwt.expiration-sec:84600}") final int expirationSec,
